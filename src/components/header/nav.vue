      ...
      <li class="list site">
        ...
        <div class="subContainer">
          ...
          <dl class="app-show">
            ...
            <dd>
              <router-link to="/">
                <img  class="appicon" src="https://s0.meituan.net/bs/fe-web-meituan/e5eeaef/img/appicons/meituan.png" alt="">
              </router-link>
            </dd>
              <dd>
              <router-link to="/">
                <img  class="appicon" src="../../assets/img/waimai.png" alt="">
              </router-link>
            </dd>
              <dd>
              <router-link to="/">
               <img  class="appicon" src="../../assets/img/zhenguo.png" alt="">
              </router-link>
            </dd>
              <dd>
              <router-link to="/">
                <img  class="appicon" src="../../assets/img/dianping.png" alt="">
              </router-link>
            </dd>
             <dd>
              <router-link to="/">
                <img  class="appicon" src="../../assets/img/maoyan.png" alt="">
              </router-link>
            </dd>
          </dl>
        </div>
